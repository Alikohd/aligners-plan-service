...
public class TaskQueueHandler {
    ...
    public void handleTask(Message<?> message) {
        try {
            ...
            if (processor == null) {
                throw new IllegalStateException("No processor found for NodeType: " + nodeType);
            }
            ...
            throw new RuntimeException("Task processing failed", e); // Сообщение остаётся в очереди
        }
    }
